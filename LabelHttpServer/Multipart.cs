...
namespace LabelHttpServer
{
    ...
    public class RequestMultipartExtensions
    {
        public Dictionary<string, HttpFile> ParseMultipartForm(HttpListenerRequest request, Dictionary<string, string> args, OnFile onFile)
        {
